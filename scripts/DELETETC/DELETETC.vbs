...
'
' Скрипт находит и удаляет все версии Total Commander.
' Версия 0.2.4 RU обновлен 25.02.2016 WinAll
' Лицензия MIT http://www.opensource.org/licenses/mit-license.php
' -----------------------------------------------------------------------
' Возможности
' - Ведется лог (%TEMP%)
' - Закрывает все дочерние процессы перед очисткой
' - Удаляет неизвестные версии
' - Удаляет ярлыки с меню пуск, быстрого запуска, отправить в..
' - Очищает реестр
' - Очищает папку TEMP и AppData
' - Очищает автозапуск
' - Возможен запуск в тихом режиме (/silent)
' -----------------------------------------------------------------------
...
MSG_Help = "Скрипт находит и удаляет все версии Total Commander. Поддерживает команды " & VbCrLf & "/silent - запуск в тихом режиме без всплывающих окон " & VbCrLf & "/version - показывает версию" & VbCrLf & "/commands - выводит список поддерживаемых команд"
CONST MSG_StartClean = "Очистить предыдущие версии Total Commander?"
CONST MSG_Commands = "Поддерживаемые команды /help, /version, /silent, /commands"
CONST MSG_Version = "0.2.4"
CONST wshYesNoDialog = 4
CONST MSG_Founded = "Найдено "
CONST MSG_NotFound = "Не найдено "
CONST MSG_Remove_Ask = "Вы уверены что хотите удалить?"
CONST MSG_Abort_Del = "Удаление остановлено пользователем "
CONST MSG_Removed = " Удалено "
CONST MSG_ErrorCheckfile = "Проверочные файлы не найдены"
CONST MSG_DefDel = "Стандартные папки очищены. "
CONST MSG_DefFold = "Найдена неизвестная версия Total Commander. Желаете удалить?"
CONST MSG_Prockilled = "Все процессы Total Commander остановлены"
CONST MSG_LinksCleaned = "Все ссылки очищены"
CONST MSG_KeyRemoved = " Удален ключ реестра"
CONST MSG_RegistryCleaned = "Реестр очищен"
CONST MSG_Finish = "Очистка завершена"
'-----------------------------------------------------------------------
